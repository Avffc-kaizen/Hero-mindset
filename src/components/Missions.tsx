    ...
    <div className="p-4 sm:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-1.5 flex gap-1">
        <button
          ...
          className={`flex-1 py-2 text-xs sm:text-sm font-mono uppercase rounded-lg transition-colors active:scale-95 ${activeTab === 'daily' ? 'bg-zinc-800 text-white' : 'text-zinc-500 hover:bg-zinc-800/50 hover:text-zinc-300'}`}
        >
          Diárias
        </button>
         <button
          onClick={() => setActiveTab('weekly')}
          className={`flex-1 py-2 text-xs sm:text-sm font-mono uppercase rounded-lg transition-colors active:scale-95 ${activeTab === 'weekly' ? 'bg-amber-800 text-white' : 'text-zinc-500 hover:bg-zinc-800/50 hover:text-zinc-300'}`}
        >
          Desafios
        </button>
        <button
          onClick={() => setActiveTab('milestone')}
          className={`flex-1 py-2 text-xs sm:text-sm font-mono uppercase rounded-lg transition-colors active:scale-95 ${activeTab === 'milestone' ? 'bg-zinc-800 text-white' : 'text-zinc-500 hover:bg-zinc-800/50 hover:text-zinc-300'}`}
        >
          Marcos
        </button>
      </div>
        ...
        {loading ? (
          <>
            ...
            <div className="text-center pt-4 pb-2">
                <p className="text-xs font-mono text-zinc-500 animate-pulse">Oráculo gerando novos protocolos...</p>
            </div>
          </>
